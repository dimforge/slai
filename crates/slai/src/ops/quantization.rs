...
mod tests {
    ...
    async fn dequantization() {
        ...
        let quant_test = QuantTest::from_backend(gpu.backend()).unwrap();
        ...
        impl<B: Backend, T: Pod, GpuT: bytemuck::Pod> TestData<B, T, GpuT> {
            fn new(backend: &B, in_vec: DVector<T>, elts_per_block: usize) -> Self {
                let out_vec = DVector::<f32>::repeat(in_vec.len() * elts_per_block, 0.0);
                let in_buf = GpuTensor::vector(
                    backend,
                    bytemuck::cast_slice(in_vec.as_slice()),
                    BufferUsages::STORAGE,
                );
                let out_buf = GpuTensor::vector(
                    backend,
                    &out_vec,
                    BufferUsages::STORAGE | BufferUsages::COPY_SRC,
                );
                let staging_buf = GpuTensor::vector(
                    backend,
                    &out_vec,
        ...
        let data_q8_0 = TestData::<_, GpuBlockQ8_0x2>::new(gpu.backend(), in_q8_0, 32);
        ...
        let data_q4_0 = TestData::<_, GpuBlockQ4_0x2>::new(gpu.backend(), in_q4_0, 32);
        ...
        let data_q4_1 = TestData::<_, GpuBlockQ4_1x2>::new(gpu.backend(), in_q4_1, 32);
        ...
        let data_q5_0 = TestData::<_, GpuBlockQ5_0x2>::new(gpu.backend(), in_q5_0, 32);
        ...
        let data_q5_1 = TestData::<_, GpuBlockQ5_1x2>::new(gpu.backend(), in_q5_1, 32);
        ...
        let data_q8_k = TestData::<_, GpuBlockQ8K>::new(gpu.backend(), in_q8_k, 256);
        ...
        let data_q5_k = TestData::<_, GpuBlockQ5K>::new(gpu.backend(), in_q5_k, 256);
        ...
        let data_q4_k = TestData::<_, GpuBlockQ4K>::new(gpu.backend(), in_q4_k, 256);
        ...
        let data_q6_k = TestData::<_, GpuBlockQ6Kx2>::new(gpu.backend(), in_q6_k, 256);
        ...
        KernelDispatch::new(gpu.backend(), &mut pass, &quant_test.dequantize)
            .bind0([
        ...
        // Test result Q8_0
        let gpu_result_v8_0 = data_q8_0.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q4_0
        let gpu_result_q4_0 = data_q4_0.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q4_1
        let gpu_result_q4_1 = data_q4_1.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q5_0
        let gpu_result_q5_0 = data_q5_0.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q5_1
        let gpu_result_q5_1 = data_q5_1.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q8K
        let gpu_result_v8_k = data_q8_k.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q5K
        let gpu_result_v5_k = data_q5_k.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q4K
        let gpu_result_v4_k = data_q4_k.staging_buf.read(gpu.backend()).await.unwrap();
        ...
        // Test result Q6K
        let gpu_result_v6_k = data_q6_k.staging_buf.read(gpu.backend()).await.unwrap();
