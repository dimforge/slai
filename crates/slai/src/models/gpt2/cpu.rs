    ...
    pub fn forward(params: &Gpt2Params, model: &mut Gpt2Model, embd: usize, pos: usize) {
        ...
        for layer in model.layers.iter_mut() {
            // Layer norm.
            {
                ...
                // [ 768, N]
                LayerNorm::<WebGpu>::run_cpu(&mut model.curr_768, &model.layer_input);
            ...
            // TODO: implement flash attention.
            {
                ...
                BatchedMultiqueryAttention::<WebGpu>::run_cpu(
                    &attn_params,
                    &model.memory_q,
                    &layer.key_cache,
                    &layer.value_cache,
            ...
            // feed-forward network
            {
                // norm
                {
                    LayerNorm::<WebGpu>::run_cpu(&mut model.curr_768, &model.curr_768_b);
